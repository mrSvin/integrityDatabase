...
#### Возможное решение:
Вести синхронной репликацию БД двух нод в две другие. Если основной контур нод падает, сервис переходит на взаимодействие с репликацией, делая репдику primary (неисправный контур при воостановлении становится репликой).
