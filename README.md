...
4. формируется перечень перерасчет трансферов с уже уникальными переводами без пересечений
5. запускаются трансферы асинхронно
6. по окончанию выполнения всех трансфер берется следующее сообщение с очереди.
